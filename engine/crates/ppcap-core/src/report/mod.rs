...
fn kind_label(k: FindingKind) -> &'static str {
    match k {
        ...
        FindingKind::MalwareDownload => "Malware Download",
...
html,body{margin:0;background:var(--bg);color:var(--text);
  font:14px/1.5 "Helvetica Neue",Helvetica,Arial,ui-sans-serif,system-ui,-apple-system,"Segoe UI",Roboto,sans-serif}
