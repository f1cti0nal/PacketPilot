      ...
      attack_chains: [
        {
          ...
          steps: [
            { order: 0, actor: "10.13.37.7", tactic_ordinal: 0, tactic: "Discovery", kind: "host_sweep",
              techniques: [{ id: "T1046", name: "Network Service Discovery" }], peer: null,
              severity: "high", score: 65, first_seen_ns: 0, last_seen_ns: 1_000_000_000,
              evidence: "24 distinct destination hosts on 445", finding_index: 0 },
            { order: 1, actor: "10.13.37.7", tactic_ordinal: 1, tactic: "Credential Access", kind: "brute_force",
              techniques: [{ id: "T1110", name: "Brute Force" }], peer: "10.66.0.1",
              severity: "high", score: 68, first_seen_ns: 2_500_000_000, last_seen_ns: 3_000_000_000,
              evidence: "30 SSH attempts", finding_index: 1 },
            { order: 2, actor: "10.66.0.1", tactic_ordinal: 4, tactic: "Command & Control", kind: "beacon",
              techniques: [{ id: "T1071", name: "Application Layer Protocol" }], peer: "45.77.13.37",
              severity: "high", score: 70, first_seen_ns: 30_000_000_000, last_seen_ns: 90_000_000_000,
              evidence: "periodic beaconing", finding_index: 2 },
            { order: 3, actor: "10.66.0.1", tactic_ordinal: 5, tactic: "Exfiltration", kind: "data_exfil",
              techniques: [{ id: "T1048", name: "Exfiltration Over Alternative Protocol" }], peer: "185.220.101.5",
              severity: "high", score: 72, first_seen_ns: 60_000_000_000, last_seen_ns: 61_000_000_000,
              evidence: "1.2 MB outbound", finding_index: 3 },
          ],
          edges: [
            { from: 0, to: 1, kind: "progression", via_kind: null, gap_ns: 1_500_000_000 },
            { from: 1, to: 2, kind: "pivot", via_kind: "brute_force", gap_ns: 27_000_000_000 },
            { from: 2, to: 3, kind: "progression", via_kind: null, gap_ns: 30_000_000_000 },
          ],
          tactics: [
            { ordinal: 0, tactic: "Discovery", techniques: [{ id: "T1046", name: "Network Service Discovery" }], host: "10.13.37.7", first_seen_ns: 0 },
            { ordinal: 1, tactic: "Credential Access", techniques: [{ id: "T1110", name: "Brute Force" }], host: "10.13.37.7", first_seen_ns: 2_500_000_000 },
            { ordinal: 4, tactic: "Command & Control", techniques: [{ id: "T1071", name: "Application Layer Protocol" }], host: "10.66.0.1", first_seen_ns: 30_000_000_000 },
            { ordinal: 5, tactic: "Exfiltration", techniques: [{ id: "T1048", name: "Exfiltration Over Alternative Protocol" }], host: "10.66.0.1", first_seen_ns: 60_000_000_000 },
          ],
          attack: ["T1046", "T1110", "T1071", "T1048"],
          campaign_id: null,
          first_ts_ns: 0,
          last_ts_ns: 90_000_000_000,
          host_count: 2,
          tactic_count: 4,
        },
      ],
