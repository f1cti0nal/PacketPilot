...
export interface ErrorStateProps {
  message: string;
  onRetry?: () => void;
  /** Heading shown above the message. Defaults to the capture-analysis copy. */
  title?: string;
}

/** Centered error screen: a critical glyph, message, and an optional retry action. */
export function ErrorState({ message, onRetry, title = "Couldn't load the capture" }: ErrorStateProps) {
  return (
    <div
