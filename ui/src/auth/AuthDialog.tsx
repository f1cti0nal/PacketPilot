...
/**
 * Sign-in entry point (modal). Native Supabase auth: email/password + Google/GitHub OAuth.
 * On sign-up with email confirmation on, we show a "check your email" state instead of closing.
 */
