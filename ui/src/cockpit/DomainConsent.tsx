...
export function DomainConsent({ domainCount, onProceed, onCancel }:
  ...
  return (
    <div ref={ref} onKeyDown={onKeyDown} role="dialog" aria-modal="true" aria-label="Domain reputation consent" className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
